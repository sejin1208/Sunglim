...
const MOCK_PRODUCTS = [
  ...
  { id: 13, name: "친환경 높낮이조절형 강화유리 중고등생 앞가림판 책상", category: "teaching", price: "77,000원", image: "SLD-17727-B.jpg", model: "SLD-17727-B", specs: "650×450×700~820mm", g2b: "25987913" },
  ...
  { id: 16, name: "친환경 높낮이조절형 강화유리 책상", category: "teaching", price: "66,500원", image: "SLD-0773.jpg", model: "SLD-0773", specs: "650×450×580~760mm", g2b: "24536047" },
  // 교실용걸상
  { id: 26, name: "친환경 높낮이조절형 중고등생 사출 걸상", category: "stationery", price: "44,000원", image: "SLC-16597.jpg", model: "SLC-16597", specs: "430×420×420~500mm", g2b: "26225887" },
  ...
  // 감독용걸상
  { id: 32, name: "수능 감독용 걸상", category: "supervision", price: "78,000원", image: "SLC-8.jpg", model: "SLC-8", specs: "430×420×800mm" },
];
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <div className="mt-4 flex items-baseline gap-1.5">
                        ...
                        <span className="text-xs text-muted-foreground">(VAT별도)</span>
                      </div>
                    </div>
                  </motion.div>
                ))}
