  ...
  const values = [
    {
      icon: ShieldCheck,
      title: "신뢰와 품질",
      desc: "수십 년간 쌓아온 신뢰를 바탕으로 가장 안전하고 우수한 품질의 학생용책걸상을 제공합니다."
    },
    {
      icon: Users,
      title: "고객 중심",
      desc: "학생들의 편의를 최우선으로 생각하여 맞춤형 솔루션을 제안합니다."
    },
    {
      icon: Target,
      title: "미래 지향",
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                ...
                <p>
                  저희 성림교구는 창립 이래 오직 '교육 환경 개선'이라는 한 길만을 걸어오며, 학교 및 교육기관에 필요한 최고의 품질의 학생용 책걸상을 공급해왔습니다. 
                </p>
                <p>
